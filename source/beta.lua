...
do
    ...
    function Funcs:AddConsole(Idx)
        local Console = {};
        
        local Groupbox = self;
        local Container = Groupbox.Container;
        
        local ConsoleOuter = Library:Create('Frame', {
            BackgroundColor3 = Color3.new(0, 0, 0);
            BorderColor3 = Color3.new(0, 0, 0);
            Size = UDim2.new(1, -4, 0, 100); -- Adjust height as needed
            ZIndex = 5;
            Parent = Container;
        });
        
        local ConsoleInner = Library:Create('Frame', {
            BackgroundColor3 = Library.MainColor;
            BorderColor3 = Library.OutlineColor;
            BorderMode = Enum.BorderMode.Inset;
            Size = UDim2.new(1, 0, 1, 0);
        ...
        Library:AddToRegistry(ConsoleInner, {
            BackgroundColor3 = 'MainColor';
            BorderColor3 = 'OutlineColor';
        });
        
        Library:OnHighlight(ConsoleOuter, ConsoleOuter,
            { BorderColor3 = 'AccentColor' },
            { BorderColor3 = 'Black' }
        );
        ...
        local TextBox = Library:Create('TextBox', {
            ...
            MultiLine = true;
            TextEditable = false; -- Make the TextBox read-only
            ZIndex = 8;
        ...
        function Console:SetValue(Text)
            Console.Value = Text;
            TextBox.Text = Text;
            Library:SafeCallback(Console.Callback, Console.Value);
        end;
        
        TextBox:GetPropertyChangedSignal('Text'):Connect(function()
            Console:SetValue(TextBox.Text);
            ScrollingFrame.CanvasSize = UDim2.new(0, 0, 0, TextBox.TextBounds.Y + 10);
        end);
        
        function Console:AddLog(Info)
            local LogCount = #ScrollingFrame:GetChildren() - 1 -- Exclude the UIListLayout
            local Log = Library:CreateLabel({
                BackgroundTransparency = 1;
                Size = UDim2.new(1, 0, 0, 20);
                Position = UDim2.new(0, 0, 0, LogCount * 20); -- Adjust position based on the number of logs
                Font = Library.Font;
                Text = Info.Text;
            ...
            Library:ApplyTextStroke(Log);
            
            ScrollingFrame.CanvasSize = UDim2.new(0, 0, 0, (LogCount + 1) * 20); -- Adjust canvas size to fit all logs
    ...
    function Funcs:AddFolder(Idx, Info)
        local Folder = {
            IsOpen = false,
            Elements = {}
        }
        ...
        local FolderOuter = Library:Create('Frame', {
            BackgroundColor3 = Color3.new(0, 0, 0),
            BorderColor3 = Color3.new(0, 0, 0),
            Size = UDim2.new(1, -4, 0, 20),
            ZIndex = 5,
        ...
        Library:AddToRegistry(FolderOuter, {
            BorderColor3 = 'Black'
        })
    
        local FolderInner = Library:Create('Frame', {
            BackgroundColor3 = Library.MainColor,
            BorderColor3 = Library.OutlineColor,
            BorderMode = Enum.BorderMode.Inset,
            Size = UDim2.new(1, 0, 1, 0),
        ...
        Library:AddToRegistry(FolderInner, {
            BackgroundColor3 = 'MainColor',
            BorderColor3 = 'OutlineColor'
        })
    
        local FolderLabel = Library:CreateLabel({
            Size = UDim2.new(1, -20, 1, 0),
            Position = UDim2.new(0, 20, 0, 0),
            TextSize = 14,
            Text = Info.Name or 'Folder',
            TextXAlignment = Enum.TextXAlignment.Left,
            ZIndex = 7,
            Parent = FolderInner
        })
        ...
        local ContentsFrame = Library:Create('Frame', {
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 0),
        ...
        function Folder:Toggle()
            ...
            ToggleButton.Text = self.IsOpen and '-' or '+'
            ContentsFrame.Visible = self.IsOpen
            Groupbox:Resize()
        end
    
        function Folder:Resize()
            ContentsFrame.Size = UDim2.new(1, 0, 0, Layout.AbsoluteContentSize.Y)
            Groupbox:Resize()
        end
        ...
        function Folder:AddElement(Element)
            Element.Parent = ContentsFrame
...
local Testing = Window:AddTab('Testing')
local TestingBox = Testing:AddLeftGroupbox('Testing')

TestingBox:AddToggle('MyToggle', {
...
local myFolder = TestingBox:AddFolder("folder1", { Name = "My Folder" })

local toggleElement = TestingBox:AddToggle('MyToggle', {
    Text = 'This is a toggle',
    Default = true, -- Default value (true / false)
    Tooltip = 'This is a tooltip', -- Information shown when you hover over the toggle
...
myFolder:AddElement(toggleElement)